...
import arithmetic
from adaptive import ArithmeticAdaptive
...
def camunzip(filename):
    ...
    elif method == 'universal_arithmetic':
        aa_algorithm = ArithmeticAdaptive()
        x = aa_algorithm.decode(y)
    else:
